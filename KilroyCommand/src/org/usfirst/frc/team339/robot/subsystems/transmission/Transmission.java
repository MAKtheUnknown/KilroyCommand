...
public class Transmission extends Subsystem
{
	...
	public void drive (double rightJoystickVal, double leftJoystickVal)
	{
		...
		double scaledRightVal =
		        this.scaleJoystickValue(rightJoystickVal);
		...
		{
			System.out
			        .println("drive():\tRF: " + scaledRightVal
			                + "\tLF: " +
			                scaledLeftVal);
		}
	...
	public void setCommandDefault (Command c)
	{
	...
	{
		final double maxCurrentGearValue =
