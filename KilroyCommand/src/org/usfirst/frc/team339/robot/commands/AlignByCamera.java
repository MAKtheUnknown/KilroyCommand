...
public class AlignByCamera extends Command {
	...
	public AlignByCamera()
	{
        ...
        this.motorRatio = this.DEFAULT_ALIGNMENT_SPEED;
	}
    ...
    protected void execute()
    {
    	...
    	if(Subsystems.goalVision.getProportionalGoalX() < X_OFFSET - DEADBAND)
    	...
    	else if(Subsystems.goalVision.getProportionalGoalX() > X_OFFSET + DEADBAND)
    	{
    		//turn right
    		Subsystems.transmission.drive(-motorRatio, motorRatio);
    	}
    ...
    protected boolean isFinished() 
    {
    	...
    	if(Subsystems.goalVision.getProportionalGoalX() >= X_OFFSET - DEADBAND
    			&& Subsystems.goalVision.getProportionalGoalX() <= X_OFFSET + DEADBAND)
